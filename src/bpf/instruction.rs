...
mod tests {
    ...
    fn decode_alu64_add_imm() {
        ...
        assert_eq!(insn.to_fstar(), "BPF_ALU64_IMM ADD R0 42");
    }
    ...
    fn decode_mov64_imm() {
        ...
        assert_eq!(insn.dst, Reg::R0);
        assert_eq!(insn.imm, 0);
        assert_eq!(insn.to_fstar(), "BPF_ALU64_IMM MOV R0 0");
    }
}
